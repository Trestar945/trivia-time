...
const mainBtn = document.querySelector('.goHome-btn');
...
function showResultBox() {
    ...
    let progress = setInterval(() => {
       ...
       circularProgress.style.background = `conic-gradient(rgb(75,192,242) ${progressStartValue * 3.6}deg, rgba(255, 255, 255, .1) 0deg)`;
